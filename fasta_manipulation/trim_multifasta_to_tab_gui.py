...
import pandas as pd
# input parameters
@Gooey(required_cols=2, program_name='multi-fasta trimmed to tabular txt file', header_bg_color= '#DCDCDC', terminal_font_color= '#DCDCDC', terminal_panel_color= '#DCDCDC')
def main(): 
    ap = GooeyParser()
