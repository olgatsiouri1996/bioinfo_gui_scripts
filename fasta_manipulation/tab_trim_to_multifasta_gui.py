...
import pandas as pd
# input arguments
@Gooey(required_cols=2, program_name='tabular trim to multi-fasta', header_bg_color= '#DCDCDC', terminal_font_color= '#DCDCDC', terminal_panel_color= '#DCDCDC')
def main(): 
    ap = GooeyParser(description="convert each row of a tabular file with the fasta headers and sequences in each row in a multi-fasta file with trimmed sequences")
