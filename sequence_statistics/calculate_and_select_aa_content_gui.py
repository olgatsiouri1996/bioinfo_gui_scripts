...
import pandas as pd
# input parameters
@Gooey(required_cols=4, program_name='calculate and select %content of any aminoacid of choice', header_bg_color= '#DCDCDC', terminal_font_color= '#DCDCDC', terminal_panel_color= '#DCDCDC')
def main():
