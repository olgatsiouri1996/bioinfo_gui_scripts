...
# input parameters
@Gooey(required_cols=4, program_name= 'replace sequence on multi-fasta', header_bg_color= '#DCDCDC', terminal_font_color= '#DCDCDC', terminal_panel_color= '#DCDCDC')
def main():
    ap = GooeyParser(description="replace subsequences with new one's in a multi-fasta file")
