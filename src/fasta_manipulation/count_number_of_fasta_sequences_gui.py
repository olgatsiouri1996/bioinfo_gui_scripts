...
# input parameters
@Gooey(required_cols=1,default_size=(610,730), program_name='count number of fasta sequences', header_bg_color= '#DCDCDC', terminal_panel_color= '#DCDCDC',terminal_font_color= '#000000',terminal_font_size=12, clear_before_run=True)
def main():
