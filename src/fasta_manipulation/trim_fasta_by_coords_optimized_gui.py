...
import  pandas as pd
# input parameters
@Gooey(required_cols=3, program_name='trim fasta by coords optimized', header_bg_color= '#DCDCDC', terminal_font_color= '#DCDCDC', terminal_panel_color= '#DCDCDC')
def main():
    ap = GooeyParser(description='trim a multi-fasta file based on a txt file with start and end coordinates')
