...
def main():
    ...
    ap.add_argument("-fa2", "--fasta2", required=True, widget='FileChooser',  help="input multi fasta file to retrieve the sequences whose fasta identifier intersects with fasta1. File can be appended")
