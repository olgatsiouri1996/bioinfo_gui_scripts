...
# input parameters
@Gooey(required_cols=3, program_name='reverse complement some fasta', header_bg_color= '#DCDCDC', terminal_font_color= '#DCDCDC', terminal_panel_color= '#DCDCDC')
def main():
    ap = GooeyParser(description="reverse complement some sequences in a multi-fasta file")
