...
# input parameters
@Gooey(required_cols=4, program_name= 'insert sequence on fasta', header_bg_color= '#DCDCDC', terminal_font_color= '#DCDCDC', terminal_panel_color= '#DCDCDC')
def main():
    ap = GooeyParser(description="insert a sequence at a specific position in a single-fasta file")
