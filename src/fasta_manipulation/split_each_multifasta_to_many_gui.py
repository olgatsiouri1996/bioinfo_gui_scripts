...
# input parameters
@Gooey(required_cols=2, program_name= 'split each multi-fasta to many', header_bg_color= '#DCDCDC', terminal_font_color= '#DCDCDC', terminal_panel_color= '#DCDCDC')
def main():
    ap = GooeyParser()
    ...
    ap.add_argument("-dir", "--directory", required=True, type=str, widget='DirChooser',  help="directory with multi-fasta files")
