...
# input parameters
@Gooey(required_cols=2, program_name= 'subset fasta records, ids or headers by chromosome/scaffold or conting', header_bg_color= '#DCDCDC', terminal_font_color= '#DCDCDC', terminal_panel_color= '#DCDCDC')
def main():
    ap = GooeyParser()
