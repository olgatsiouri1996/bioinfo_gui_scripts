...
# input parameters
@Gooey(required_cols=2, program_name='complement fasta', header_bg_color= '#DCDCDC', terminal_font_color= '#DCDCDC', terminal_panel_color= '#DCDCDC')
def main():
    ap = GooeyParser(description="complement the sequences of a multi or single-fasta file")
