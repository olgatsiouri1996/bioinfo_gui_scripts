...
def main():
    ...
    ap.add_argument("-out", "--output", required=True, widget='FileSaver', help="4-column tab-seperated output txt file with the rate of tf productions and the input columns")
